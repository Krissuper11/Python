...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
    sorted_most_hobbies = sorted(people_list, key=lambda x: (len(x.hobbies) * -1, x.first_name))
    return sorted_most_hobbies
...
def sort_by_least_hobbies(people_list: list) -> list:
    ...
    :return: sorted list of people.
    """
    sorted_least_hobbies = sorted(people_list, key=lambda x: (len(x.hobbies), x.first_name))
    return sorted_least_hobbies
...
def sort_people_and_hobbies(people_list: list) -> list:
    ...
    :return: sorted list of people.
    """
    people_list = sorted(people_list, key=lambda x: x.first_name)
    for name in people_list:
        name.hobbies = sorted(name.hobbies)
    return people_list
